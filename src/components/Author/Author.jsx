...
class Author extends Component {
  render() {
    ...
    if (author !== null) {
      return (
        <div className="full-author-bio bg-gray-100 rounded -mx-4 p-4 lg:mx-auto lg:p-8 md:flex items-center text-sm sm:text-base lg:text-lg">
          <div className="text-center prose flex flex-col justify-center bio-avatar w-1/4 sm:w-1/6 float-left -mt-2 -ml-2 sm:mt-0 sm:ml-0 mb-2 mr-4 md:mb-0 md:mr-8" style={{minWidth: '5em',}}>
            { author.Website ? 
              <a href={author.Website} target="_blank" className="border-4 for-bg overflow-hidden rounded-lg" rel="noopener noreferrer">
          ...
          <div className="bio-text">
            ...
            <ul className="follow-author mt-4 flex flex-wrap items-center leading-none">
              ...
              { author.Author_Email&& <li>
                  <a className="tooltip md:mr-2 p-2 block author-email" target="_blank" rel="noopener noreferrer" href={'mailto:' + author.Author_Email} data-tooltip="Email">
              ...
              { author.Website && <li>
                  <a className="tooltip md:mr-2 p-2 block author-website" target="_blank" rel="noopener noreferrer" href={author.Website} data-tooltip="Website">
              ...
              { author.LinkedIn && <li>
                <a className="tooltip md:mr-2 p-2 block author-linkedin" target="_blank" rel="noopener noreferrer" href={`https://linkedin.com/in/` + author.LinkedIn} data-tooltip="LinkedIn">
              ...
              { author.Twitter && <li>
                <a className="tooltip md:mr-2 p-2 block author-twitter" target="_blank" rel="noopener noreferrer" href={`https://twitter.com/` + author.Twitter} data-tooltip="Twitter">
              ...
              { author.Facebook && <li>
                <a className="tooltip md:mr-2 p-2 block author-facebook" target="_blank" rel="noopener noreferrer" href={`https://facebook.com/` + author.Facebook} data-tooltip="Facebook">
              ...
              { author.Instagram && <li>
                <a className="tooltip md:mr-2 p-2 block author-instagram" target="_blank" rel="noopener noreferrer" href={`https://instagram.com/` + author.Instagram} data-tooltip="Instagram">
      ...
      return (
        <div className="minimal-author-bio bg-gray-100 rounded -mx-4 p-4 lg:mx-auto lg:p-8 flex items-center text-sm sm:text-base lg:text-lg">
          <Gravatar email={post.Email} size={96} className="rounded-lg border-2 border-gray-300 mr-4 sm:mr-6" alt={'Author Headshot'}/>

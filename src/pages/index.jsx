      ...
      <Layout>
        ...
        <section className="relative griddled wrap pb-10">
          <div className="primary">
            ...
            <p className="text-lg theme-font mb-6 rounded-sm">Read the <a className="underline hover:text-gray-500" href="https://www.facilitator.cards/blog/virtual-facilitation-strike-a-pose-i-know-i-wonder-case-studies-dot-voting/" target="_blank" rel="noopener noreferrer">detailed agenda on the Facilitator Cards Blog</a> for facilitating this stack.</p>
